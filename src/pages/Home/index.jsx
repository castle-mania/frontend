    ...
    <Container maxW="container.xl">
      ...
      {/* <Box margin={12}>
        <Step videoUrl="/videos/profile_command.mp4">
          ...
          <Text>
            Generators will gain you coins over time, there are many different types of generators with unique
            properties. continue to see how to acquire your first generator!
          </Text>
        </Step>
        <Step videoUrl="/videos/buy_command.mp4">
          ...
          <Text>
            Congrats, you&apos;re now earning coins! revisiting your profile will display your new generators!
          </Text>
        </Step>
