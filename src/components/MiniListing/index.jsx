...
export default function MiniListing({name, description, url, onCheckout, price, loaded, amount}) {
  ...
  return (
    <Box
      ...
      <Skeleton isLoaded={loaded} p={4}>
        <Image w="100%" src={`${process.env.PUBLIC_URL}${url}`} alt={name} fallback={<Box mt="100%" />} p={16} />
